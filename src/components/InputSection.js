        ...
        <>
            ...
            <div className="section_button_container">
                {renderSaveButton(
                    ...
                    currentEsthetician,
                    sectionArr,
                    changeCurrentFacialPrices ? changeCurrentFacialPrices : changeCurrentAddOnPrices ? changeCurrentAddOnPrices : changeCurrentExtrasPrices ? changeCurrentExtrasPrices : null,
                    spinnerLoading,
                    changeSpinnerLoading
                )}
                {sectionTitle !== "Total" ? <Button outline color="secondary" className="section_button"><IoMdAddCircleOutline /> Add Line Item</Button> : null}
            </div>
            {sectionTitle === "Total" ? (
                <>
                    <InputGroup>
